import{j as a}from"./index-CTAXdLKx.js";import{r as w}from"./index-D5jfS-9e.js";import{C as D,a as E,S as g,P as Ee,D as Ae,b as pe,Q as ce,i as gn,c as Re,d as fn,G as Sn,e as Cn,f as _,W as wn,A as Te,O as yn,g as vn,h as Ge,T as Me,U as bn,j as xn}from"./useGroup-BY64lRtW.js";import"./client-Spw3EFno.js";import{m as Dn,a as En,e as An,b as Rn,c as Tn}from"./data-C1F8hFnR.js";const Gn=[40,80,120,200],fe=l=>{var we,ye,ve,be,xe,De;const{enableRtl:F,enableRipple:p,localDataCount:f,isTextWrapData:b,isDialogInsideGrid:x,isStrictMode:$,isMultipleChildren:J,parentContainerHeight:X="87vh",isCustomBinding:z,serverPageSize:Y,defaultOpenGroupExpandKeys:q,isConditionalRowSelection:Se,...n}=l;((ve=(ye=n.columns)==null?void 0:ye[((we=n.columns)==null?void 0:we.length)-1])==null?void 0:ve.headerText)==="Command Actions"&&(n.columns[((be=n.columns)==null?void 0:be.length)-1].getCommandItems=()=>[a.jsx(D,{type:E.Edit},"Edit"),a.jsx(D,{type:E.Delete},"Delete"),a.jsx(D,{type:E.Update},"Update"),a.jsx(D,{type:E.Cancel},"Cancel")]);const m=w.useRef(null),me=w.useRef(null),[he,sn]=w.useState(!0),[R,dn]=w.useState(!1),y=w.useMemo(()=>b?Dn(f):En(f,n.columns),[f,(xe=n.columns)==null?void 0:xe.length]),[un,cn]=w.useState({result:[],count:0,hasMore:((De=l.virtualizationSettings)==null?void 0:De.scrollMode)===g.Infinite}),ge=w.useCallback(e=>{if(!e.isComplex)return new Ee(e.field,e.operator,e.value,e.ignoreCase,e.ignoreAccent,e.matchCase);let t=null;const o=e.predicates||[],d=e.condition||"and";for(let u=0;u<o.length;u++){const s=ge(e.predicates[u]);t===null?t=s:t=d.toLowerCase()==="or"?t.or(s):t.and(s)}return t||new Ee("","","")},[]),Ce=e=>{var d,u,s,c,v,S,T,V,I,O,N,L,j,P,W,G,H,M,U,k,B,K,ee;const t=new pe(y),o=new ce;if((d=e.where)!=null&&d.length){const r=e.where[0],i=ge(r);o.where(i)}if((u=e.search)!=null&&u.length){const{fields:r,value:i}=e.search[0];o.search(i,r)}if((s=e.sort)!=null&&s.length||(c=e.groups)!=null&&c.length&&e.isInitialLoad)if(e.isInitialLoad&&((v=e.groups)!=null&&v.length)){const r=[];for(let i=e.sort.length-1;i>-1;i--)(r==null?void 0:r.find(h=>h.field===e.sort[i].field))||((S=e.groups)!=null&&S.length&&((T=e.groups)!=null&&T.includes(e.sort[i].field))?r.push({field:e.sort[i].field,direction:e.sort[i].direction}):o.sortBy(e.sort[i].field,e.sort[i].direction));r.length&&r.forEach(i=>{o.sortBy(i.field,i.direction)})}else e.sort.forEach(r=>{o.sortBy(r.field,r.direction)});if((V=e.aggregates)!=null&&V.length||(O=(I=m.current)==null?void 0:I.aggregates)!=null&&O.length){const r=(N=e.aggregates)!=null&&N.length?e.aggregates:(L=m.current)==null?void 0:L.aggregates;for(let i=0;i<(r==null?void 0:r.length);i++)if((j=r[i])!=null&&j.columns)for(let C=0;C<((P=r[i])==null?void 0:P.columns.length);C++){const h=r[i].columns[C];if(Array.isArray(h.type))for(let Q=0;Q<h.type.length;Q++)o.aggregate((H=(G=(W=h.type)==null?void 0:W[Q])==null?void 0:G.toLowerCase)==null?void 0:H.call(G),h.field);else o.aggregate((U=(M=h.type)==null?void 0:M.toLowerCase)==null?void 0:U.call(M),h.field)}else{const C=r[i];o.aggregate((B=(k=C.type)==null?void 0:k.toLowerCase)==null?void 0:B.call(k),C.field)}}if(e.groups&&((K=e.groups)!=null&&K.length))for(let r=0;r<e.groups.length;r++){const i=e.groups[parseInt(r.toString(),10)];o.group(i)}if(e.take&&e.skip){const r=e.skip/e.take+1,i=e.take;o.page(r,i)}else if(e.skip===0&&e.take)o.page(1,e.take);else if(!gn(e.skip)&&!e.take&&((ee=l.virtualizationSettings)==null?void 0:ee.scrollMode)===g.Infinite){const r=e.skip/Y+1;o.page(r,Y)}e.requiresCounts&&o.requiresCount(),t.executeQuery(o).then(r=>{if(e.requestType==="filterChoiceRequest"){const i={result:Re.distinct(r.result,e.select[0],!0),count:r.count};if(e.distinctCounts){const C=new ce;if(e.distinct){const h=e.distinct[0],Q=ge(h);C.where(Q)}e.select&&C.select(e.select),t.executeQuery(C).then(h=>{i.distinctCount=Re.distinct(h.result,e.select[0],!0).length,e.dataSource(i)})}else e.dataSource(i)}else cn({...r,hasMore:y.length>(e.skip??0)+r.result.length})})},pn=e=>{setTimeout(()=>{if(e.action==="Add"&&y.unshift(e.data),e.action==="Edit"){for(var t=0;t<y.length;t++)if(y[t].id==e.data.id){y[t]=e.data;break}}if(e.action=="Delete"){for(var o=0;o<e.data.length;o++)for(var t=0;t<y.length;t++)if(y[t].id==e.data[o].id){y.splice(t,1);break}}e.saveDataChanges()},0)},mn=w.useMemo(()=>{var d,u;if(!z)return;const e=((d=n==null?void 0:n.aggregates)==null?void 0:d.reduce((s,c)=>{var v;return(v=c.columns)==null||v.forEach(S=>{Array.isArray(S.type)?S.type.forEach(T=>{s.push({type:T.toLowerCase(),field:S.field})}):s.push({type:S.type.toLowerCase(),field:S.field})}),s},[]))??[],t=((u=n==null?void 0:n.columns)==null?void 0:u.reduce((s,c)=>(c.groupCaptionAggregateType&&s.push(...Array.isArray(c.groupCaptionAggregateType)?c.groupCaptionAggregateType.map(v=>({type:v.toLowerCase(),field:c.field})):[{type:c.groupCaptionAggregateType.toLowerCase(),field:c.field}]),s),[]))??[],o=e==null?void 0:e.concat(t);return o!=null&&o.length?o:void 0},[z,n==null?void 0:n.aggregates,n==null?void 0:n.columns,R]);w.useEffect(()=>{var e,t,o,d,u,s,c,v,S,T,V,I,O,N,L,j,P,W,G,H,M;z&&R&&Ce({skip:((e=n==null?void 0:n.pageSettings)==null?void 0:e.currentPage)*((t=n==null?void 0:n.pageSettings)==null?void 0:t.pageSize)||0,...((o=n.virtualizationSettings)==null?void 0:o.scrollMode)!==g.Infinite||(d=n.pageSettings)!=null&&d.estimatedTotalRecordsCount||((u=n.pageSettings)==null?void 0:u.pageSizeControlledBy)==="client"?{take:Y??((s=n==null?void 0:n.pageSettings)==null?void 0:s.pageSize)??(((c=n.virtualizationSettings)==null?void 0:c.scrollMode)===g.Auto||!((v=n.virtualizationSettings)!=null&&v.scrollMode)?12:50)}:{take:Y},groups:(S=n==null?void 0:n.groupSettings)==null?void 0:S.columns,where:[],search:[],sort:(T=n==null?void 0:n.sortSettings)!=null&&T.enabled&&((I=(V=n==null?void 0:n.sortSettings)==null?void 0:V.columns)!=null&&I.length)&&(!((O=n==null?void 0:n.groupSettings)!=null&&O.enabled)||!((N=n==null?void 0:n.groupSettings)!=null&&N.columns))?(L=n==null?void 0:n.sortSettings)==null?void 0:L.columns:(((j=n==null?void 0:n.sortSettings)==null?void 0:j.columns)??[]).concat((P=n==null?void 0:n.groupSettings)!=null&&P.enabled&&((W=n==null?void 0:n.groupSettings)!=null&&W.columns)?(H=(G=n==null?void 0:n.groupSettings)==null?void 0:G.columns)==null?void 0:H.map(U=>{var k,B,K;return{field:U,direction:((K=(B=(k=n==null?void 0:n.sortSettings)==null?void 0:k.columns)==null?void 0:B.find(ee=>ee.field===U))==null?void 0:K.direction)??"Ascending"}}):[]),aggregates:mn??[],...((M=n.virtualizationSettings)==null?void 0:M.scrollMode)!==g.Infinite?{requiresCounts:!0}:{},isInitialLoad:!0})},[R]);const hn=w.useCallback(e=>e.id%2===0||e.EmployeeID%2===0||e.RecordId%2===0?{selectable:!1}:!0,[Se]),Z=()=>{var e;return a.jsxs(a.Fragment,{children:[a.jsxs("button",{onClick:()=>{var t,o;R&&window.localStorage.removeItem((o=(t=m==null?void 0:m.current)==null?void 0:t.getDataModule())==null?void 0:o.dataManager.guidId),dn(!R)},children:[R?"Destroy":"Render"," Data Grid"]}),f&&!b&&a.jsxs("button",{onClick:()=>sn(!he),children:[he?"Uniform":"Non Uniform"," Row Height Applied"]}),(e=n==null?void 0:n.groupSettings)!=null&&e.enabled?a.jsxs(a.Fragment,{children:[a.jsx("button",{onClick:()=>{var t,o,d;(d=(t=m.current)==null?void 0:t.groupColumn)==null||d.call(t,(o=n==null?void 0:n.groupSettings)==null?void 0:o.columns,!0)},children:"Reset Grouped Columns to Default"}),a.jsx("button",{onClick:()=>{var t,o,d,u,s;(s=(t=m.current)==null?void 0:t.ungroupColumn)==null||s.call(t,[(u=(d=(o=m.current)==null?void 0:o.groupSettings)==null?void 0:d.columns)==null?void 0:u[0]])},children:"Un Group First Grouped Column"}),a.jsx("button",{onClick:()=>{var t,o;(o=(t=m.current)==null?void 0:t.expandAll)==null||o.call(t)},children:"Expand All"}),a.jsx("button",{onClick:()=>{var t,o;(o=(t=m.current)==null?void 0:t.collapseAll)==null||o.call(t)},children:"Collapse All"}),a.jsx("button",{onClick:()=>{var t,o;(o=(t=m.current)==null?void 0:t.clearGrouping)==null||o.call(t)},children:"Clear Grouping"})]}):null,a.jsx("br",{}),a.jsx("br",{}),R&&a.jsx(fn,{dir:F?"rtl":"ltr",ripple:p,locale:n.locale,children:a.jsx(Sn,{resizeSettings:{enabled:!0,mode:"Normal"},ref:m,dataSource:z?un:f?y:[],onDataRequest:z?Ce:void 0,onDataChangeRequest:z?pn:void 0,shouldExpandGroup:q!=null&&q.length?t=>{var o;return(o=q.includes)==null?void 0:o.call(q,t==null?void 0:t.groupKey)}:void 0,onError:t=>{console.error("Grid Error: ",t)},...n,isRowSelectable:Se?hn:void 0,columns:n.children?void 0:n.columns,aggregates:n.children?void 0:n.aggregates,getRowHeight:he?null:t=>Gn[t.rowIndex%4],children:J?n.children.props.children:n.children})}),a.jsx("br",{}),a.jsx("button",{onClick:()=>{console.log(m)},children:"dummy navigation checking button with get GridRef"})]})};return a.jsx("div",{ref:me,style:{height:X,isolation:"isolate"},children:$?a.jsx(w.StrictMode,{children:x?a.jsx(Ae,{open:!0,fullScreen:!0,target:me.current,children:Z()}):Z()}):x?a.jsx(Ae,{open:!0,fullScreen:!0,target:me.current,children:Z()}):Z()})};try{fe.displayName="LargeDataGridTest",fe.__docgenInfo={description:"",displayName:"LargeDataGridTest",props:{parentContainerHeight:{defaultValue:null,description:"",name:"parentContainerHeight",required:!1,type:{name:"Height<string | number>"}},enableRtl:{defaultValue:null,description:`Enables right-to-left (RTL) direction for the grid.
...
\`\`\``,name:"onDeleteDialogOpen",required:!1,type:{name:"(eventArgs: DeleteDialogEventArgs) => void"}}}}}catch{}const On={title:"Grid/VirtualGridBase",component:fe,parameters:{layout:"fullscreen",docs:{description:{component:"A fully configurable Grid component with performance comparison capabilities."}}},argTypes:{localDataCount:{control:"select",options:["0","100","1000","10000","100000"],description:"Grid Local DataSource Count"}}},A=Tn(100,!1),Mn=[{columns:Rn(A.length)}];A.unshift({type:_.Checkbox,width:50,allowFilter:!1});A.push({headerText:"Command Actions",width:200,getCommandItems:()=>[a.jsx(D,{type:E.Edit},"Edit"),a.jsx(D,{type:E.Delete},"Delete"),a.jsx(D,{type:E.Update},"Update"),a.jsx(D,{type:E.Cancel},"Cancel")]});const ne={args:{localDataCount:1e5,columns:A,aggregates:Mn,groupSettings:{enabled:!1,columns:["category","product","region"],showDropArea:!0,type:Cn.SingleColumn,defaultExpanded:!0},onGroupStart:()=>{console.log("onGroupStart Started")},onGroup:l=>{console.log("Group action: ",l)},onSortStart:()=>{console.log("Sort Started")},onSort:l=>{console.log("Sort action: ",l)},defaultOpenGroupExpandKeys:["Camera","Camera-South America","Gaming Chair","Gaming Chair-South Asia","Tires","Tires-East Asia","Air Conditioner","Air Conditioner-North Africa","Game Controller","Game Controller-South Asia","Mouse","Mouse-South America","Accessories","Accessories-Camera","Accessories-Camera-South America","Construction","Construction-Gaming Chair","Construction-Gaming Chair-South Asia","Energy","Energy-Tires","Energy-Tires-East Asia","Healthcare","Healthcare-Air Conditioner","Healthcare-Air Conditioner-North Africa","Logistics","Logistics-Game Controller","Logistics-Game Controller-South Asia","Peripherals","Peripherals-Mouse","Peripherals-Mouse-South America"],virtualizationSettings:{scrollMode:g.Virtual,enableCache:!1,viewPortBuffer:{columns:10}},editSettings:{allowEdit:!0,allowAdd:!0,allowDelete:!0,mode:"Normal"},toolbar:["Add","Edit","Delete","Update","Cancel","Search"],searchSettings:{enabled:!0},sortSettings:{enabled:!0},filterSettings:{enabled:!0,type:"Excel",enableFilterBarOperator:!0},pageSettings:{enabled:!0,pageSize:1e5},height:"100%",onRowSelect:l=>{console.log("Row Selected: ",l)}}},te={args:{localDataCount:2e6,isConditionalRowSelection:!0,columns:A.slice(0,11),editSettings:{allowEdit:!0,allowAdd:!0,allowDelete:!0,mode:"Normal"},toolbar:["Add","Edit","Delete","Update","Cancel","Search"],searchSettings:{enabled:!0},sortSettings:{enabled:!0},filterSettings:{enabled:!0,enableFilterBarOperator:!0},pageSettings:{enabled:!0,pageSize:2e6},height:"100%"}},ae={args:{dataSource:new pe({url:"https://ej2services.syncfusion.com/js/development/api/UrlDataSource",adaptor:new bn}),query:new ce().addParams("dataCount","100000"),toolbar:["Search"],isConditionalRowSelection:!0,groupSettings:{enabled:!1,showDropArea:!0,type:"GroupRows",defaultExpanded:!0,columns:["Designation","Employees"]},onGroup:l=>{console.log("Group action: ",l)},defaultOpenGroupExpandKeys:["CFO","CFO-Kathryn Fuller","Designer","Designer-Kathryn Fuller","Developer","Developer-Kathryn Fuller","Project Lead","Project Lead-Kathryn Fuller","System Analyst","System Analyst-Kathryn Fuller"],columns:[{type:_.Checkbox,width:50,allowFilter:!1},{field:"EmployeeID",visible:!0,headerText:"Employee ID",isPrimaryKey:!0,width:"150"},{field:"Employees",headerText:"Employee Name",width:"230",clipMode:"EllipsisWithTooltip"},{field:"Designation",headerText:"Designation",width:"170",clipMode:"EllipsisWithTooltip"},{field:"Mail",headerText:"Mail",width:"230"},{field:"Location",headerText:"Location",width:"140"},{field:"Status",headerText:"Status",width:"130"},{field:"Trustworthiness",headerText:"Trustworthiness",width:"160"},{field:"Rating",headerText:"Rating",width:"220"},{field:"Software",headerText:"Software Proficiency",width:"180",format:"C2"},{field:"CurrentSalary",headerText:"Current Salary",width:"200",format:"C2"},{field:"Address",headerText:"Address",width:"240",clipMode:"EllipsisWithTooltip"}],searchSettings:{enabled:!0},sortSettings:{enabled:!0},filterSettings:{enabled:!0,type:"Excel"},pageSettings:{pageSize:50},virtualizationSettings:{enableCache:!1,scrollMode:g.Virtual},height:"100%"}},oe={args:{dataSource:new pe({url:"https://ej2services.syncfusion.com/react/development/api/GridWebAPIService",adaptor:new xn}),columns:[{type:_.Checkbox,width:50,allowFilter:!1},{field:"OrderID",headerText:"OrderID",isPrimaryKey:!0,width:"130",allowSearch:!1},{field:"CustomerID",headerText:"CustomerID",width:"230",clipMode:"EllipsisWithTooltip"},{field:"ShipCity",headerText:"ShipCity",width:"230"},{field:"EmployeeID",headerText:"EmployeeID",width:"130",clipMode:"EllipsisWithTooltip",allowSearch:!1},{field:"EmployeeName",headerText:"EmployeeName",width:"230",clipMode:"EllipsisWithTooltip",allowSearch:!1,allowFilter:!1,allowSort:!1},{field:"Designation",headerText:"Designation",width:"230",clipMode:"EllipsisWithTooltip",allowSearch:!1,allowFilter:!1,allowSort:!1},{field:"CurrentSalary",headerText:"CurrentSalary",width:"130",clipMode:"EllipsisWithTooltip",allowSearch:!1,allowFilter:!1,allowSort:!1}],isConditionalRowSelection:!0,sortSettings:{enabled:!0},filterSettings:{enabled:!0},virtualizationSettings:{scrollMode:g.Virtual},height:"100%",query:new ce().addParams("serverpagesize","50")}},re={args:{dataSource:An,children:a.jsxs(vn,{children:[a.jsx(Ge,{headerText:"Employee Image",width:"180",textAlign:Me.Center,field:"EmployeeID"}),a.jsx(Ge,{headerText:"Employee Details",width:"300",textAlign:Me.Left,field:"FirstName"})]}),className:"row-template",toolbar:["Search"],selectionSettings:{mode:"Single"},searchSettings:{enabled:!0},sortSettings:{enabled:!0},filterSettings:{enabled:!0},height:"100%",rowTemplate:l=>{const F=`https://npmci-react.syncfusion.com/development-react-ui/images/grid/${l.EmployeeID}.png`;return a.jsxs("tr",{className:"templateRow",children:[a.jsx("td",{className:"photo",children:a.jsx("img",{src:F,alt:l.EmployeeID.toString()})}),a.jsx("td",{className:"details",children:a.jsxs("table",{className:"CardTable",cellPadding:3,cellSpacing:2,children:[a.jsxs("colgroup",{children:[a.jsx("col",{style:{width:"30%"}}),a.jsx("col",{style:{width:"10%"}})]}),a.jsxs("tbody",{children:[a.jsxs("tr",{children:[a.jsx("td",{className:"CardHeader",children:"First Name"}),a.jsx("td",{children:":"}),a.jsx("td",{children:l.FirstName})]}),a.jsxs("tr",{children:[a.jsx("td",{className:"CardHeader",children:"Last Name"}),a.jsx("td",{children:":"}),a.jsx("td",{children:l.LastName})]}),a.jsxs("tr",{children:[a.jsx("td",{className:"CardHeader",children:"Title"}),a.jsx("td",{children:":"}),a.jsx("td",{children:l.Title})]})]})]})})]})}}},kn=[{field:"id"},{field:"username",width:150},{field:"age",width:80,type:"number"},{field:"bio",width:400}],ie={args:{localDataCount:1e5,isTextWrapData:!0,columns:kn,height:400,textWrapSettings:{enabled:!0,wrapMode:wn.Both}}},le={args:{localDataCount:1e3,columns:(()=>{let l=[...A.slice(0,11)];return l.unshift({type:_.SingleGroup,format:"C2"}),l=l.map(F=>({...F,...F.field==="sales"?{groupCaptionAggregateType:[Te.Min,Te.Max],valueAccessor:p=>{var f,b,x;return((f=p.column)!=null&&f.groupCaptionAggregateType&&((b=p.data)!=null&&b.key)?"Min & Max: ":"")+((x=p.data)==null?void 0:x[p.field])},template:p=>{var f,b,x,$,J,X;return(f=p.column)!=null&&f.groupCaptionAggregateType&&((b=p.data)!=null&&b.key)?`Min & Max: ${($=p.data)==null?void 0:$[(x=p.column)==null?void 0:x.field]}`:((X=p.data)==null?void 0:X[(J=p.column)==null?void 0:J.field])??""},width:280,format:"C2"}:{}})),l})(),onDataLoadStart:l=>{console.log("onDataLoadStart: ",l)},onGroupStart:()=>{console.log("onGroupStart Started")},onGroup:l=>{console.log("Group action: ",l)},onSortStart:()=>{console.log("Sort Started")},onSort:l=>{console.log("Sort action: ",l)},groupSettings:{enabled:!0,columns:["category","product","region"],defaultExpanded:!0,showDropArea:!0,type:"SingleColumn",captionFormat:"verbose"},sortSettings:{enabled:!0,columns:[{field:"product",direction:"Descending"}]},isCustomBinding:!0,pageSettings:{enabled:!0,pageSize:2},virtualizationSettings:{scrollMode:g.Virtual},defaultOpenGroupExpandKeys:["Camera","Camera-South America","Medical Scanner","Medical Scanner-East Asia","Gaming Chair","Gaming Chair-South Asia","Laptop","Laptop-North America","Tires","Tires-East Asia","Scanner","Scanner-Western Europe","Air Conditioner","Air Conditioner-North Africa","E-learning Tablet","E-learning Tablet-Nordics","Game Controller","Game Controller-South Asia","Whiteboard","Whiteboard-Middle East","Mouse","Mouse-South America","Microwave","Microwave-Sub-Saharan Africa","Accessories","Accessories-Camera","Accessories-Camera-South America","Agriculture","Agriculture-Medical Scanner","Agriculture-Medical Scanner-East Asia","Construction","Construction-Gaming Chair","Construction-Gaming Chair-South Asia","Electronics","Electronics-Laptop","Electronics-Laptop-North America","Energy","Energy-Tires","Energy-Tires-East Asia","Furniture","Furniture-Scanner","Furniture-Scanner-Western Europe","Healthcare","Healthcare-Air Conditioner","Healthcare-Air Conditioner-North Africa","Insurance","Insurance-E-learning Tablet","Insurance-E-learning Tablet-Nordics","Logistics","Logistics-Game Controller","Logistics-Game Controller-South Asia","Networking","Networking-Whiteboard","Networking-Whiteboard-Middle East","Peripherals","Peripherals-Mouse","Peripherals-Mouse-South America","Retail","Retail-Microwave","Retail-Microwave-Sub-Saharan Africa"],editSettings:{allowEdit:!0,allowAdd:!0,allowDelete:!0,mode:"Normal"},toolbar:["Add","Edit","Delete","Update","Cancel","Search"],searchSettings:{enabled:!0},filterSettings:{enabled:!0,enableFilterBarOperator:!0,type:"Excel"},height:"100%"}},se={args:{dataSource:new pe({url:"https://ej2services.syncfusion.com/react/development/odata/GridInfiniteODataV4",adaptor:new yn}),columns:[{type:_.Checkbox,width:50,allowFilter:!1},{field:"RecordId",headerText:"Record ID",isPrimaryKey:!0},{field:"AssetGroup",headerText:"Asset Group"},{field:"HourlyCost",headerText:"Hourly Cost"},{field:"EstimatedHours",headerText:"Estimated Hours"},{field:"MaintenanceCost",headerText:"Maintenance Cost"},{field:"RequestedDate",headerText:"Requested Date"},{field:"PlannedDate",headerText:"Planned Date"},{field:"CompletionDate",headerText:"Completion Date"},{field:"Status",headerText:"Status"},{field:"RequestOrigin.Division",headerText:"Request Division"}],isConditionalRowSelection:!0,virtualizationSettings:{scrollMode:g.Infinite,enableCache:!0},sortSettings:{enabled:!0},filterSettings:{enabled:!0},searchSettings:{enabled:!0},toolbar:["Search"],height:"100%"}},de={args:{serverPageSize:50,localDataCount:5e3,columns:A.slice(1,11),isCustomBinding:!0,virtualizationSettings:{scrollMode:g.Infinite},sortSettings:{enabled:!0},filterSettings:{enabled:!0,enableFilterBarOperator:!0},searchSettings:{enabled:!0},editSettings:{allowEdit:!0,allowAdd:!0,allowDelete:!0,mode:"Normal"},toolbar:["Search","Add","Edit","Delete","Update","Cancel"],pageSettings:{enabled:!1,pageSize:50},height:"100%"}},ue={args:{serverPageSize:50,localDataCount:5e3,columns:A.slice(0,11),isCustomBinding:!0,virtualizationSettings:{scrollMode:g.Virtual},isConditionalRowSelection:!0,sortSettings:{enabled:!0},filterSettings:{enabled:!0,enableFilterBarOperator:!0},searchSettings:{enabled:!0},editSettings:{allowEdit:!0,allowAdd:!0,allowDelete:!0,mode:"Normal"},toolbar:["Search","Add","Edit","Delete","Update","Cancel"],height:"100%"}};var ke,Fe,ze;ne.parameters={...ne.parameters,docs:{...(ke=ne.parameters)==null?void 0:ke.docs,source:{originalSource:`{
  args: {
    localDataCount: 100000,
    columns: columns,
    // columns: (() => {
    //     let groupingColumns = [...columns];
    //     groupingColumns.unshift({ type: ColumnType.SingleGroup }); //, headerText: 'Product Group'
    //     groupingColumns = groupingColumns.map((col) => {
    //         return ({...col, ...(col.field === 'sales' ? {groupCaptionAggregateType: AggregateType.Min} : {}) });
    //     });
...
}`,...(Le=(Ne=ae.parameters)==null?void 0:Ne.docs)==null?void 0:Le.source}}};var je,Pe,We;oe.parameters={...oe.parameters,docs:{...(je=oe.parameters)==null?void 0:je.docs,source:{originalSource:`{
  args: {
    dataSource: new DataManager({
...
}`,...(We=(Pe=oe.parameters)==null?void 0:Pe.docs)==null?void 0:We.source}}};var He,Ue,Be;re.parameters={...re.parameters,docs:{...(He=re.parameters)==null?void 0:He.docs,source:{originalSource:`{
  args: {
    dataSource: employeeData,
    children: <Columns>\r
